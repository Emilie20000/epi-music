...
const ProductAdminList = () => {
    ...
    return (
        <div className="container mx-auto p-4">
            ...
            <h1 className={`text-2xl font-bold mb-4 ${textColor}`}>Liste des Produits</h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {products.map((product) => {
                    ...
                    return (
                        <div key={product.id} className={`p-6 rounded-lg shadow-xl ${cardBg} transition-all ease-in-out duration-300`}>
                ...
                <span className={`${subTextColor} line-through text-lg`}>
                    ...
                    ${promotion.promo_price}
                                ...
                                <p className={`text-lg font-semibold mb-4 ${subTextColor}`}>
