  ...
  return (
    <>
      ...
      <div className="container mx-auto p-4">
        ...
        {formattedCategory ? (
          <h1 className="text-center text-4xl font-bold my-4">{formattedCategory}</h1>
        ) : (
          <h1 className="text-center text-4xl font-bold my-4">Tous les produits</h1>
        )}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 flex flex-col justify-between">
                        ...
                        {!formattedCategory && <p className="line-clamp-3 mb-2">Catégorie : {product.category}</p>}
                              ...
                              <>
                                {filteredModel.stock > 0 && filteredModel.stock <= 5 ? (
                                  <>
                                    ...
                                    <p className="text-orange-500 font-bold">Bientôt épuisé</p>
                                  </>
                        ...
                        {promotion ? (
                          <div className="flex flex-col mb-2">
                            <span className="text-gray-500 line-through text-lg">${filteredModel?.price?.toFixed(2) || "Non disponible"}</span>
                          ...
                          <p className="text-xl font-bold">${filteredModel?.price?.toFixed(2) || "Non disponible"}</p>
                        )}
                      </div>
