...
const CartPage = () => {
  ...
  const handleQuantityChange = (id, newQuantity, newTotal) => {
    setItems((prevItems) => prevItems.map((item) => (item.id === id ? { ...item, quantity: newQuantity, total: newTotal } : item)));
  };
  ...
  return (
    <>
      ...
      <div className="w-9/12 m-auto">
        ...
        <h1 className="text-center text-4xl font-bold my-4">Panier</h1>
            ...
            items.length !== 0 && total ? (
              <>
                ...
                <div className="w-full lg:w-1/2 xl:w-1/3 md:p-4 mb-4">
                  ...
                  <CartButton text="Valider mon panier" handleClick={getShippingCost} />
                </div>
              </>
            ) : (
              <div className="text-center mt-40 text-2xl">
                <p>Votre panier est vide</p>
                <button className="bg-rose-600 text-2xl rounded-xl mt-8 text-black" onClick={() => (window.location.href = "/products")}>
