...
const DeliveryHomePage = () => {
  ...
  const [cartPrice, setCartPrice] = useState(parseFloat(localStorage.getItem("cart_price") || 0));
  const [shippingCosts, setShippingCosts] = useState(parseFloat(localStorage.getItem("cart_shipping_costs") || 0));
  const [cartQuantity, setCartQuantity] = useState(parseInt(localStorage.getItem("cart_quantity") || 0));
  ...
  const handleAddressChange = (e) => {
    const selectedAddress = addresses.find((address) => address.id === parseInt(e.target.value));
  ...
  return (
    <>
      ...
      <div className="w-9/12 m-auto">
        ...
        <h1 className="text-center text-4xl font-bold my-4">Livraison à domicile</h1>
        <div className="w-full">
          <div className="max-w-5xl mx-auto px-6 sm:px-6 lg:px-8 mt-8 mb-8">
            <div className="bg-white w-full shadow rounded p-8 sm:p-12">
              <p className="text-3xl font-bold leading-7 text-center text-black">Adresse de livraison</p>
              ...
              {displayState && (
                <div className="md:flex items-center mt-4">
                  <div className="w-full flex flex-col">
                    <label htmlFor="address-select" className="text-gray-700">
                      Carnet d'adresses
                    </label>
                    <select
                      id="address-select"
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button type="submit" className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-500 mt-4">
