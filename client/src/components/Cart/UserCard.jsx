        ...
        <div className="flex flex-col items-center p-6" aria-label="Section du profil utilisateur">
            {user && (
                ...
                >
                    ...
                    <h2 className="text-xl font-bold mb-4" role="heading" aria-level="2">
                        Informations utilisateur
                    </h2>
                    <p className="text-center" aria-label={`Prénom: ${user.firstname}`}>
                        <strong>Prénom :</strong> {user.firstname}
                    </p>
                    <p className="text-center" aria-label={`Nom: ${user.lastname}`}>
                        <strong>Nom :</strong> {user.lastname}
                    </p>
                    <p className="text-center" aria-label={`Email: ${user.email}`}>
                        <strong>Email :</strong> {user.email}
                    </p>
                    <p className="text-center" aria-label={`Rôle: ${getRoleLabel()}`}>
