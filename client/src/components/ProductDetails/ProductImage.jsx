...
const ProductImage = ({ images }) => {
  ...
  const [selectedImage, setSelectedImage] = useState(
    mainImages.length > 0 ? mainImages[0].path : (secondaryImages.length > 0 ? secondaryImages[0].path : '')
  );
  ...
  return (
    <div className="relative image-container" aria-label="Zone d'image du produit">
      {selectedImage && (
        <div
      ...
      {images.length > 0 && (
        <div className="flex gap-4 overflow-x-auto mt-4" aria-label="Galerie d'images du produit">
